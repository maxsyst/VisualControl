...
namespace VueExample.Providers.Srv6
{
    public class ParcelProvider : IParcelProvider
    {
        ...
        {
            return await _srv6Context.Parcels.FirstOrDefaultAsync(x => x.Id == id);
        }

        public async Task<Parcel> GetByWaferId(string waferId)
        {
            ...
            return parcel == null ? new NullParcelObject() : parcel;
        }
    }
}