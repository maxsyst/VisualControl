...
namespace VueExample.Providers.ChipVerification
{
    public class MeasurementSetProvider : IMeasurementSetProvider
    {
        ...
        public (MeasurementSetViewModel, Error) Create(string name)
        {
            ...
            return (new MeasurementSetViewModel
            {
        ...
        public List<MeasurementSetViewModel> GetAllSets(int facilityId)
        {
            ...
            var measurementSetsFromDb = _applicationContext.MeasurementSet.FromSqlInterpolated($"EXECUTE dbo.MeasurementSetByFacilityID @facilityID = {facilityId}").ToList();
        ...
        public List<AtomicMeasurementExtendedViewModel> GetAtomicsById(Guid measurementSetId, IMeasurementProvider measurementProvider)
        {
            ...
            atomicViewModelList.AddRange(from atomic in atomicList
                                         ...
                                         {
                                             AtomicMeasurementId = atomic.Id,
                                             DeviceId = atomic.DeviceId,
                                             DeviceName = atomic.Device.Name,
                                             MeasurementId = atomic.MeasurementId,
                                             MeasurementName = atomic.Measurement.Name,
                                             GraphicId = atomic.GraphicId,
                                             GraphicUnit = atomic.Graphic.Unit,
        ...
        private MeasurementSetViewModel GenerateOnlineMeasurementSet()
        {
            return new MeasurementSetViewModel
            {
                MeasurementSetId = Guid.NewGuid(),
                Name = _appSettings.OnlineName,
                IsGenerated = true,
                Route = "online"
            };
        }
        ...
        private List<MeasurementSetViewModel> GenerateMaterialBasedMeasurementSets()
        {
            ...
            {
                materialBasedMeasurementSetsList.Add(new MeasurementSetViewModel
                {
                    MeasurementSetId = Guid.NewGuid(),
                    Name = material.Name,
                    IsGenerated = true,
