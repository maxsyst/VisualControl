  ...
  methods: {
    ...
    wipe(action) {
      ...
      action.parameter = {
        ...action.parameter,
        ...{
          id: 0, parameterName: '', russianParameterName: '', parameterNameStat: '', dividerNeed: false, specialRon: false,
        },
      };
    },
    ...
    async createParameter() {
      const parameterViewModel = { ...this.creating.parameter };
    ...
    async updateParameter() {
      const parameterViewModel = { ...this.editing.parameter };
